#ifndef _GENERAL_TREE_HPP_
#define _GENERAL_TREE_HPP_
...
namespace Rcpp {
  ...
  template <> GeneralTreeInternals as(SEXP gti_exp) {
    List lst = as<List>(gti_exp);

    GeneralTreeInternals gti;
