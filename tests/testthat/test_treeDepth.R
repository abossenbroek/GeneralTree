...
test_that("depth reports the correct depth for singleton tree", {
  tree <- GeneralTree$new(0, "parent1")
  expect_equal(tree$depth, 0)
})


test_that("depth reports the correct depth when creating a tree", {
  tree <- GeneralTree$new(0, "parent1")
...
test_that("depth reports the correct depth when creating a tree with two levels deep", {
  tree <- GeneralTree$new(0, "parent1")
  ...
  expect_equal(tree$depth, 2)
})


test_that("depth reports the correct depth when deleting a child", {
  tree <- GeneralTree$new(0, "parent1")
...
test_that("depth reports the correct depth when deleting a child", {
  ...
  expect_equal(tree$depth, 4)
})

test_that("depth reports the correct depth when adding nodes in any order", {
...
test_that("depth reports the correct depth asking tree depth on child node", {
  tree <- GeneralTree$new(0, "parent1")
  ...
  expect_equal(tree$searchNode(4)$depth, 0)
})
